...
/*  int i; */
  ...
  TIC(30)/* TODO: missing time from fdct */, fdct (block, 8);  // 8x8 Blocks, DC precision value = 0, Quantization coefficient (mquant) = 64   
