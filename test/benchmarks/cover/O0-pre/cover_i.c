...
{TIC(0); 
	int i;
	for (i=0; TIC(108), i<10; i++) {
		switch (i) {
			case 0: TIC(12), c++; break;
			case 1: TIC(12), c++; break;
			case 2: TIC(12), c++; break;
			case 3: TIC(12), c++; break;
			case 4: c++; break;
			case 5: TIC(12), c++; break;
			case 6: TIC(12), c++; break;
			case 7: TIC(12), c++; break;
			case 8: TIC(12), c++; break;
			case 9: TIC(12), c++; break;
			default: c--; break;
		}
	}
	TIC(42); return c;
