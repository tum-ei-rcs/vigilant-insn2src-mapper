   ...
   while (TIC(11658), dummy_i > 0) {
      ...
      if ( (P2_is_marked >= 5) &&
         ...
         if ((b > a)) {
				...
				/* demarking of input places */
            TIC(99), P2_marking_member_0[0] = P2_marking_member_0[3];
            P2_is_marked -= 4;
      ...
      if ( (P2_is_marked >= 5) &&
         ...
         if ((b > a)) {
				...
				/* demarking of input places */
            TIC(99), P2_marking_member_0[0] = P2_marking_member_0[2];
            P2_is_marked -= 4;
      ...
      if ( (P2_is_marked >= 5) &&
         ...
         if ((b > a)) {
				...
				/* demarking of input places */
            TIC(99), P2_marking_member_0[0] = P2_marking_member_0[1];
            P2_is_marked -= 4;
