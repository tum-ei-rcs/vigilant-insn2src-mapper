...
{TIC(0); 
   ...
   TIC(16), tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL = time;
   ...
   TIC(16), tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRLexited_BEREIT_FH_TUERMODUL_CTRL = time;
   if ((sc_FH_TUERMODUL_CTRL_2375_2 != 0) && (TIC(206), time - sc_FH_TUERMODUL_CTRL_2375_2 >= 0.5))
   {
      FH_TUERMODUL__MFHA_copy = 0;
      sc_FH_TUERMODUL_CTRL_2375_2 = 0;
      
   }
   if ((TIC(26), sc_FH_TUERMODUL_CTRL_2352_1 != 0) && (TIC(196), time - sc_FH_TUERMODUL_CTRL_2352_1 >= 0.5))
   {
      TIC(10), FH_TUERMODUL__MFHZ_copy = 0;
      sc_FH_TUERMODUL_CTRL_2352_1 = 0;
      
   }
   if ((sc_FH_TUERMODUL_CTRL_2329_1 != 0) && (TIC(196), time - sc_FH_TUERMODUL_CTRL_2329_1 >= 0.5))
   {
      TIC(10), FH_TUERMODUL__MFHZ_copy = 0;
      sc_FH_TUERMODUL_CTRL_2329_1 = 0;
      
   }
   if ((TIC(13), sc_FH_TUERMODUL_CTRL_1781_10 != 0) && (TIC(196), time - sc_FH_TUERMODUL_CTRL_1781_10 >= 0.5))
   {
      TIC(8), sc_FH_TUERMODUL_CTRL_1781_10 = 0;
      
   }
   if ((TIC(13), sc_FH_TUERMODUL_CTRL_1739_10 != 0) && (TIC(204), time - sc_FH_TUERMODUL_CTRL_1739_10 >= 0.5))
   {
      sc_FH_TUERMODUL_CTRL_1739_10 = 0;
      
   }
   if ((SYS_bit_get(Bitlist, entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRL_IDX) || TIC(12), BLOCK_ERKENNUNG_CTRL__N != BLOCK_ERKENNUNG_CTRL__N_old))
...
void init(void)
{TIC(0); 
    TIC(71), tm_entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRLch_BLOCK_ERKENNUNG_CTRL__N_copy = 0;
...
{TIC(0); 
   ...
   {
      switch (TIC(152), KINDERSICHERUNG_CTRL_KINDERSICHERUNG_CTRL_next_state)
      {
         case 1 : /** state ZENTRAL in chart KINDERSICHERUNG_CTRL **/
         {
            if (TIC(5), !(TIC(100), FH_TUERMODUL__SFHA_ZENTRAL || FH_TUERMODUL__SFHZ_ZENTRAL))
            {
               TIC(13), stable = 0;
         ...
         {
            if (!(TIC(12), FH_TUERMODUL__SFHA_MEC || FH_TUERMODUL__SFHZ_MEC))
            {
               TIC(13), stable = 0;
                FH_TUERMODUL__SFHZ_copy = 0;
                 FH_TUERMODUL__SFHA_copy = 0;
            ...
            switch (TIC(72), MEC_KINDERSICHERUNG_CTRL_next_state)
            {
               case 1 : /** state INMEC in chart KINDERSICHERUNG_CTRL **/
               {
                  if ((TIC(5), FH_TUERMODUL__SFHA_MEC && !(FH_TUERMODUL__SFHA_MEC_old)))
                  {
                     TIC(10), stable = 0;
                      FH_TUERMODUL__SFHA_copy = 1;
         ...
         {
            if ((TIC(5), !FH_TUERMODUL__KL_50) && (FH_TUERMODUL__SFHZ_MEC && FH_TUERMODUL__SFHA_MEC))
            {
               TIC(13), stable = 0;
                 FH_TUERMODUL__SFHZ_copy = 1;
                 FH_TUERMODUL__SFHA_copy = 1;
...
{TIC(0); 
   if (TIC(24), !SYS_bit_get(Bitlist, active_FH_TUERMODUL_CTRL_IDX) && SYS_bit_get(Bitlist,active_FH_TUERMODUL_CTRL_old_IDX) && !SYS_bit_get(Bitlist,active_FH_TUERMODUL_CTRL_copy_IDX))
   {
   ...
   {
      if (TIC(5), !SYS_bit_get(Bitlist, active_KINDERSICHERUNG_CTRL_IDX))
      {
         TIC(3), KINDERSICHERUNG_CTRL_KINDERSICHERUNG_CTRL_next_state = 3;
      }
      ...
      switch (B_FH_TUERMODUL_CTRL_next_state)
      {
         ...
         {
            if ((TIC(28), FH_TUERMODUL_CTRL__N == 59 && TIC(2), !(FH_TUERMODUL_CTRL__N_old == 59)))
            {
               stable = 0;
         ...
         {
            if (((TIC(74), FH_TUERMODUL__BLOCK && TIC(5), !(FH_TUERMODUL__BLOCK_old))) && TIC(5), ((FH_TUERMODUL__MFHZ)))
            {
               TIC(28), stable = 0;
         ...
         {
            if (((TIC(590), FH_TUERMODUL_CTRL__N > 60 && TIC(8), !(FH_TUERMODUL_CTRL__N_old > 60))) && ((TIC(5), !(TIC(5), FH_TUERMODUL_CTRL__INREVERS1 || FH_TUERMODUL_CTRL__INREVERS2))))
            {
               TIC(11), stable = 0;
               FH_TUERMODUL__MFHZ_copy = 0;
               FH_TUERMODUL__MFHA_copy = 0;
            ...
            if (((TIC(5), FH_TUERMODUL__BLOCK && !(FH_TUERMODUL__BLOCK_old))) && ((FH_TUERMODUL__MFHA)))
            {
               TIC(28), stable = 0;
               FH_TUERMODUL__MFHA_copy = 0;
      ...
      switch (TIC(8), A_FH_TUERMODUL_CTRL_next_state)
      {
         case 1 : /** state WIEDERHOLSPERRE in chart FH_TUERMODUL_CTRL **/
         {
            ...
            if ((step == 1 && TIC(35), tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRLexited_BEREIT_FH_TUERMODUL_CTRL != 0 && (time - tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRLexited_BEREIT_FH_TUERMODUL_CTRL == 1)) && ((FH_TUERMODUL__MFHZ || TIC(5), FH_TUERMODUL__MFHA)))
            {
               TIC(23), stable = 0;
            ...
            switch (TIC(33), WIEDERHOLSPERRE_FH_TUERMODUL_CTRL_next_state)
            {
               case 1 : /** state WDHSP in chart FH_TUERMODUL_CTRL **/
               {
                  if ((TIC(65), step == 1 && tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL != 0 && (time - tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL == 3)) && (((!(FH_TUERMODUL__MFHZ || FH_TUERMODUL__MFHA)) && FH_TUERMODUL_CTRL__N > 0)))
                  {
                     stable = 0;
                     FH_TUERMODUL_CTRL__N = FH_TUERMODUL_CTRL__N - 1;
...
{TIC(0); 
   ...
   {
      switch (TIC(9), EINKLEMMSCHUTZ_CTRL_EINKLEMMSCHUTZ_CTRL_next_state)
      {
...
{TIC(0); 
   if (TIC(19), !SYS_bit_get(Bitlist, active_BLOCK_ERKENNUNG_CTRL_IDX) && SYS_bit_get(Bitlist,active_BLOCK_ERKENNUNG_CTRL_old_IDX) && TIC(5), !SYS_bit_get(Bitlist,active_BLOCK_ERKENNUNG_CTRL_copy_IDX))
   {
      SYS_bit_clr (Bitlist, entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRL_IDX);
   }
   if (SYS_bit_get(Bitlist,active_BLOCK_ERKENNUNG_CTRL_IDX))
   {
      switch (BLOCK_ERKENNUNG_CTRL_BLOCK_ERKENNUNG_CTRL_next_state)
      {
         ...
         {
            if ((FH_TUERMODUL__I_EIN != FH_TUERMODUL__I_EIN_old) && ((TIC(2), FH_TUERMODUL__I_EIN > 0)))
            {
               stable = 0;
         ...
         {
            if ((TIC(21), !(FH_TUERMODUL__MFHA) && FH_TUERMODUL__MFHA_old) || (!(FH_TUERMODUL__MFHZ) && TIC(5), FH_TUERMODUL__MFHZ_old))
            {
               stable = 0;
            ...
            switch (BEWEGUNG_BLOCK_ERKENNUNG_CTRL_next_state)
            {
               ...
               {
                  if ((TIC(15), FH_TUERMODUL__I_EIN > (BLOCK_ERKENNUNG_CTRL__I_EIN_MAX - 2)))
                  {
                     TIC(10), stable = 0;
               ...
               {
                  SYS_bit_clr (Bitlist, entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRL_IDX);
                  if ((BLOCK_ERKENNUNG_CTRL__N == 11 && TIC(8), !(BLOCK_ERKENNUNG_CTRL__N_old == 11)))
                  {
                     TIC(7), stable = 0;
                  ...
                  /** static reactions: **/
                  if (TIC(2), BEWEGUNG_BLOCK_ERKENNUNG_CTRL_next_state == 3)
                       {
   ...
   while (TIC(5), !stable)
   {
      ...
      step++;
      {
         switch (FH_STEUERUNG_DUMMY_FH_STEUERUNG_DUMMY_next_state)
         {
            ...
            {
               if ((TIC(7), !(FH_DU__MFHZ) && FH_DU__MFHZ_old))
               {
                  TIC(11), stable = 0;
                  FH_DU__MFH = 0;
            ...
            {
               if ((TIC(13), FH_DU__MFHZ && TIC(5), !(FH_DU__MFHZ_old)))
               {
                  TIC(13), stable = 0;
                  FH_DU__MFH = -100;
               ...
               if ((TIC(5), FH_DU__MFHA && !(FH_DU__MFHA_old)))
               {
                  TIC(13), stable = 0;
                  FH_DU__MFH = 100;
            ...
            {
               if ((TIC(7), !(FH_DU__MFHA) && TIC(5), FH_DU__MFHA_old))
               {
                  TIC(11), stable = 0;
                  FH_DU__MFH = 0;
      ...
      {
         {
            ...
            if (!SYS_bit_get(Bitlist, active_EINKLEMMSCHUTZ_CTRL_IDX))
            {
               TIC(3), EINKLEMMSCHUTZ_CTRL_EINKLEMMSCHUTZ_CTRL_next_state = 1;
            }
            SYS_bit_clr(Bitlist, active_EINKLEMMSCHUTZ_CTRL_copy_IDX);
            if (!SYS_bit_get(Bitlist, active_BLOCK_ERKENNUNG_CTRL_IDX))
            {
            ...
            {
                if ((TIC(5), !FH_DU__DOOR_ID))
               {
                  TIC(4), FH_DU__S_FH_FTZU = FH_DU__S_FH_TMBFZUCAN;
                  
               }
               
            }
            if (TIC(7), FH_DU__S_FH_TMBFZUDISC != FH_DU__S_FH_TMBFZUDISC_old)
            {
                if (TIC(9), FH_DU__DOOR_ID)
               {
            ...
            if (TIC(7), FH_DU__S_FH_TMBFAUFCAN != FH_DU__S_FH_TMBFAUFCAN_old)
            {
                if ((TIC(5), !FH_DU__DOOR_ID))
               {
                  TIC(4), FH_DU__S_FH_FTAUF = FH_DU__S_FH_TMBFAUFCAN;
                  
               }
               
            }
            if (TIC(7), FH_DU__S_FH_TMBFAUFDISC != FH_DU__S_FH_TMBFAUFDISC_old)
            {
                if (TIC(5), FH_DU__DOOR_ID)
               {
                  TIC(4), FH_DU__S_FH_TMBFAUFCAN = FH_DU__S_FH_TMBFAUFDISC;
...
int main(void)
{TIC(0); 
  TIC(40)/* TODO: missing time from init */, init();
  interface();
  FH_DU();
